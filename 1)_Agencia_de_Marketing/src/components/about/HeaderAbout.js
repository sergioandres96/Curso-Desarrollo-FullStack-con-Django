        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-4xl font-bold tracking-tight pb-16 sm:text-7xl">About Us</h1>
                    <p className="font-normal text-xl leading-6 text-black ">En Borcelle, nos apasiona ayudar a nuestros clientes a alcanzar el éxito en el mundo digital. 
                                                                             Somos una agencia de marketing digital especializada en crear estrategias y campañas efectivas para promocionar marcas, productos y servicios en línea.
                                                                             Nuestro equipo está compuesto por expertos en diferentes áreas del marketing digital, como SEO, PPC, social media, email marketing y diseño web. 
                                                                             Trabajamos de manera colaborativa para desarrollar soluciones personalizadas que se adapten a las necesidades y objetivos de cada cliente.</p>
                </div>
            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-xl leading-6 text-black ">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.In the first place we have granted to God, and by this our present charter confirmed for us and our heirs forever that the English Church shall be free, and shall have her rights entire, and her liberties inviolate; and we will that it be thus observed; which is apparent from</p>
                </div>
