...
function Footer(){
    return(
        <footer className="bg-gray-450" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <img
              ...
              <div className="flex space-x-6">
                {navigation.social.map((item) => (
                  <a key={item.name} href={item.href} className="text-white-200 hover:text-gray-500">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Sergio Garcia by Creative, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
