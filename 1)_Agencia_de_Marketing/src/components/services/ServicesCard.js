    ...
    return(
        <div 
         ...
         onMouseLeave={()=>{
           ...
           className="w-full relative p-8 h-96 lg:h-[200pm] bg-white shadow-xl hover:-translate-y-1 duration-300 ease-in-out">
            <div className="w-full">
             ...
             <div className="absolute bottom-0 left-0 p-8">  
                    <h2 id={index} className=" items-end text-xl font-semibold pt-8">lear More</h2>
